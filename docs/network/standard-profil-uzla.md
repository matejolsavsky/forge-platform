...
Tvar dopytu, jeho životný cyklus a register dopytov upravuje samostatný dokument siete **`dopyt-v-sieti.md`**.
...
| 2026-09-10 | **Spresnený odkaz na dokument dopytu (§1)** — všeobecná veta „Tvar dopytu upraví samostatný dokument siete." nahradená konkrétnym názvom **`dopyt-v-sieti.md`** a doplnená o životný cyklus a register dopytov. Spresnenie bolo možné až po **D-2026-22**, keď dokument dopytu dostal verejnú adresu v tom istom priečinku (`docs/network/`) — dovtedy by verejná kópia štandardu odkazovala na súbor, ktorý v jej priečinku nie je. **Text štandardu, povinné sekcie ani verzia sa nemenia — v0.3.** Zadanie riaditeľa 2026-09-08 bod 4 (inbox podľa P-009) — WS-011, SESSION-0061 |
