...
**Owner:** WS-011 · **Verzia:** 0.3 · **Status:** Draft · **Dátum:** 2026-09-07
...
Anglické znenie je `node-participation-terms.md` (v0.3); obe verzie nesú tú istú verziu a menia sa spolu.
...
platforma), **D-2026-19** (uzol vedený zákonným zástupcom), **D-2026-20** (kapacita má druh; ten istý slovník pre
ponuku aj dopyt) — `registry/decisions.md`.
...
`druhy-kapacit.md` (akého druhu môže byť kapacita uzla), `forge-platform` (kód, ktorý profily číta a kontroluje).
...
**Do siete sa neprispieva len strojom.** To, čo uzol vie dať k dispozícii, je **kapacita**, a stroj je len jeden
z jej druhov — rovnako ňou je doprava, priestor, ruky a čas, znalosť, materiál, digitálny podklad, právna
spôsobilosť, financovanie alebo dosah. Druhy sú vymenované v samostatnom dokumente **`druhy-kapacit.md`**
a **ten istý slovník používa aj dopyt** — inak by ich sieť nikdy nespárovala.
...
- Uzol vedie svoj profil (`PROFILE.md`) podľa **verejného štandardu profilu uzla**; svoje kapacity v ňom
  popisuje **druhmi zo spoločného slovníka**, a ak jeho kapacita do žiadneho druhu nepadá, uvedie druh `iné`
  a popíše ju vlastnými slovami. Profil je na verejnej
...
profil sa odchýlil od tvaru, ktorý sieť očakáva. **Druh kapacity, ktorý slovník ešte nepozná, profil nerobí
nesúladným** — kontrola ho len vypíše a je to podnet na doplnenie slovníka, nie chyba uzla.

## 4. Za pravdivosť ručí uzol

Údaje v profile — kapacity a ich druhy, materiály, lehoty, ceny, kontakty, záujem — sú **vyhlásením uzla**. Forge
ich neoveruje, nepotvrdzuje a neručí za ne, ani za splnenie zákaziek, ktoré uzol prijme. Platí to rovnako pre profil
hostený uzlom aj pre profil hostený platformou v jeho mene. Kto s uzlom obchoduje, obchoduje s ním, nie s Forge.
...
- Uzol o zápis **požiada** (issue v repozitári platformy alebo e-mail; rovnakou cestou požiada aj o hostovanie
  profilu platformou a rovnakou cestou navrhne nový druh kapacity); zapisuje **prevádzkovateľ siete**.
...
Platí to aj pre kapacitu druhu `financovanie`: sieť eviduje len to, že taká kapacita existuje — **nikdy sumy,
podmienky ani prevody** — a žiadne platby nesprostredkúva.
...
| 2026-09-07 | **v0.3 — kapacita má druh (D-2026-20)**; menené len tam, kde text hovoril o strojoch alebo o kapacite, obsah ostatných pravidiel sa nemení: §1 doplnené o vetu **„do siete sa neprispieva len strojom"** a o odkaz na slovník `druhy-kapacit.md`, ktorý používa aj dopyt; §2 doplnené o to, že uzol popisuje kapacity druhmi a pri kapacite mimo slovníka použije `iné`; §3 doplnené o pravidlo, že **neznámy druh nerobí profil nesúladným**; §4 „kapacita" → **„kapacity a ich druhy"**; §5 doplnené, že novým druhom sa navrhuje tou istou cestou ako zápis; §7 doplnené o hranicu pri druhu `financovanie` (sieť eviduje existenciu kapacity, nie sumy, podmienky ani prevody — **D-2026-6**, **D-2026-14**). Anglické znenie `node-participation-terms.md` → v0.3 v tej istej zmene. Rozhodnutie riaditeľa 2026-09-07 (inbox podľa P-009, zadanie SESSION-0058) — WS-011, SESSION-0058 |
